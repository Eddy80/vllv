        ...
        <div class="row">
            @foreach ($packets as $packet)
              <div class="col-md-3 text-center" style="background-color: transparent;padding-bottom: 10px;background-position: bottom;width: 272px;">
                  <div class="text-center bg-white border rounded border-danger" data-bs-hover-animate="pulse" style="box-shadow: 3px 3px gray; background-color: #fff;margin-top: 10px;padding: 10px;"><img class="img-fluid" src="assets/img/{{$packet->img}}" style="background-color: #fff;" width="250p">
                      ...
                      <button class="btn btn-primary text-center" type="button" style="  box-shadow: 3px 3px gray; background-color: #FF6A00;font-size: 20px;width: 130px;margin-top: 10px;margin-bottom: 10px;"><strong>ÜZV OL</strong></button>
                      </a>
                    </div>
              </div>
            @endforeach
