  ...
  <div class="simple-slider">
      <div class="swiper-container">
          <div class="swiper-wrapper">
              <div data-aos="slide-left" data-aos-duration="5" class="swiper-slide" style="background-image: url(&quot;assets/img/gizli.jpg&quot;);background-size: contain;background-repeat: no-repeat;background-position: center;background-color: #000;"></div>
              <div data-aos="slide-left" data-aos-duration="5" class="swiper-slide" style="background-image: url(&quot;assets/img/kouch.jpg&quot;);background-size: contain;background-repeat: no-repeat;background-position: center;background-color: #000;"></div>
              <div data-aos="slide-left" data-aos-duration="5" class="swiper-slide" style="background-image: url(&quot;assets/img/oguzsaygin.jpg&quot;);background-size: contain;background-repeat: no-repeat;background-position: center;background-color: #000;"></div>
          </div>
  ...
  <div class="article-list" style="background-color: #E6E6E6;">
      <div class="container" style="background-color: #E6E6E6;">
          <div class="d-inline intro">
              <h3 class="text-center d-inline-block" style="padding-top: 27px;color: #FF7E00;">Yeni</h3>
              <h3 class="text-center d-inline-block" style="padding-top: 27px;color: #7a7774;font-size: 26px;">&nbsp;|&nbsp;</h3>
              <h3 class="text-center d-inline-block" style="padding-top: 27px;color: #7a7774;font-size: 26px;">Populyar</h3>
          </div>
          <div class="row articles" style="padding-bottom: 0px;">
              <div class="col-sm-6 col-md-4 m-auto item" data-bs-hover-animate="pulse"><a href="#"></a>
                  <div style="padding: 12px;background-color: #fff;padding-bottom: 35px;"><img class="img-fluid" src="assets/img/building.jpg" style="margin-top: 0;">
                      ...
                      <h3 class="text-left name" style="font-size: 20px;margin-top: 11px;margin-bottom: 10px;height: 70px;">Gizli hipnoz təlimi</h3><a class="btn btn-primary text-left d-inline-block float-left d-xl-flex justify-content-xl-start" role="button" data-bs-hover-animate="pulse" href="#" style="background-color: #FF7E00;color: #fff;padding: 6px;padding-bottom: 2px;font-size: 12px;padding-top: 2px;"><strong>BAXMAQ</strong></a>
                      <strong
                  ...
                  <p class="description"></p><a class="action" href="#"></a><em style="margin-left: 80px;"></em></div>
              <div class="col-sm-6 col-md-4 m-auto item" data-bs-hover-animate="pulse"><a href="#"></a>
                  <div style="padding: 12px;background-color: #fff;padding-bottom: 35px;"><img class="img-fluid" src="assets/img/building.jpg" style="margin-top: 0;">
                      <h6 class="text-left">Expert: Təbriz Hacınski</h6>
                      <h3 class="text-left name" style="font-size: 20px;margin-top: 11px;margin-bottom: 10px;height: 70px;">Gizli hipnoz təlimi</h3><a class="btn btn-primary text-left d-inline-block float-left d-xl-flex justify-content-xl-start" role="button" data-bs-hover-animate="pulse" href="#" style="background-color: #FF7E00;color: #fff;padding: 6px;padding-bottom: 2px;font-size: 12px;padding-top: 2px;"><strong>BAXMAQ</strong></a>
...
@include('comments')
    ...
    <div class="highlight-blue" style="background-color: #fff;margin-top: 0px;">
        <div class="container">
            <div class="intro">
